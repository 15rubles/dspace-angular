...
export class AdminSidebarComponent extends MenuComponent implements OnInit {
  ...
  ngOnInit(): void {
    super.ngOnInit();
    this.expandedSidebarWidth$ = this.variableService.getVariable('--ds-admin-sidebar-total-width');
    this.collapsedSidebarWidth$ = this.variableService.getVariable('--ds-admin-sidebar-fixed-element-width');
